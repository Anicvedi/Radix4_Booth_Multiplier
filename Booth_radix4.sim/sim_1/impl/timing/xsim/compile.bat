...
REM
REM Generated by Vivado on Wed Mar 18 17:06:23 +0530 2026
...
echo "xvlog --incr --relax -prj tb_booth_radix4_csa_multiplier_wave_vlog.prj"
call xvlog  --incr --relax -prj tb_booth_radix4_csa_multiplier_wave_vlog.prj -log xvlog.log
