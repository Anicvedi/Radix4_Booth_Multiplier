...
HD_PWD='C:/Users/Anirudh/Booth_radix4/Booth_radix4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log booth_radix4_csa_multiplier.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source booth_radix4_csa_multiplier.tcl -notrace
