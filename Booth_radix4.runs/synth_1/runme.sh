...
HD_PWD='C:/Users/Anirudh/Booth_radix4/Booth_radix4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log booth_radix4_csa_multiplier.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source booth_radix4_csa_multiplier.tcl
